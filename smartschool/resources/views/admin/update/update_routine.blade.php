...
@section('maincontent')
<h4 id="e">UPDATE ROUTINE</h4><br><br>
...
{!! Form::open(['url' => '/update_routine', 'method'=>'POST', 'enctype'=>'multipart/form-data']) !!}
    ...
    <input type="hidden" name="Routine_id" value="{{ $update_routine_id->id }}">  
