...
<br>
{!! Form::open(['url' => '/student_login', 'method'=>'POST', 'enctype'=>'multipart/form-data']) !!}
...
<div align="center">
    <div class="form-group" style="width: 50%">
      ...
      <input type="text" class="form-control" id="inputPassword4" name="Student_id" placeholder="your Employee id..." required>
    </div>
    <div class="form-group" style="width: 50%">
